...
export default function VehicleFinancingPage() {
  ...
  return (
    <>
      ...
      <section className="py-16" style={{ background: "linear-gradient(135deg, #1E40AF, #2563EB)" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-black text-white mb-4">Prêt pour votre nouveau véhicule ?</h2>
          <Link href="/client/register"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white mt-6 transition-all hover:-translate-y-1"
