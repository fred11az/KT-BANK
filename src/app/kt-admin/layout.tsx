...
import { Users, Inbox, LayoutDashboard, LogOut, Lock, Settings, ArrowLeftRight, Menu, X, CreditCard, FileText, ShieldEllipsis } from "lucide-react";
...
const NAV = [
  ...
  { href: "/kt-admin/strategy", label: "Salon Stratégie", icon: ShieldEllipsis },
